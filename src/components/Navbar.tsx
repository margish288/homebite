      ...
      <div className='container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-16 lg:h-20'>
          ...
          <div className='flex items-center'>
            <Link
              href='/'
              className='flex items-center space-x-2 text-xl lg:text-2xl font-bold text-ink dark:text-dark-text hover:text-primary-500 transition-colors'
            >
          ...
          <div className='hidden lg:flex items-center space-x-6'>
            ...
            {session && (session.user as any).role === "user" && <CartButton />}
            ...
            {session ? (
              <>
                {(session.user as any).role === "cook" && (
                  <Link
                    href='/cook/dashboard'
                    className='text-ink-light dark:text-dark-text-muted hover:text-primary-500 font-medium transition-colors'
                  >
                    Dashboard
                  </Link>
                )}
